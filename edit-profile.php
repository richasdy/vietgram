        ...
        <div class="edit-profile__container">
            <header class="edit-profile__header">
                <div class="edit-profile__avatar-container">
                    <img src="<?= $dataInfo['fotoProfile']; ?>" class="edit-profile__avatar" />
                </div>
                <h4 class="edit-profile__username"><?= $dataInfo['username']; ?></h4>
            </header>
            <form action="updateProfile.php" method="post" class="edit-profile__form">
                <div class="form__row">
                    <label for="full-name" class="form__label">Name:</label>
                    <input id="full-name" type="text" name="fullName" class="form__input" />
                </div>
                <div class="form__row">
                    <label for="user-name" class="form__label">Username:</label>
                    <input id="user-name" type="text" name="username" class="form__input" />
                </div>
                <div class="form__row">
