...
<html lang="en">
    <?php 
        ...
        $jmlData_photo = $data_photo->num_rows();
    ...
    <body>
        ...
        <main id="feed">
            <?php
              for ($i=0; $i < $jmlData_photo; $i++) { 
            ?>
            <div class="photo">
                <header class="photo__header">
                    <img src="assets/images/feed/irfanprakoso/gambar2.JPEG" class="photo__avatar" />
                    <div class="photo__user-info">
                        <span class="photo__author"><?php echo $_SESSION['username'];?></span>
                    </div>
                </header>
                <center><img class="img-fluid" height="300px" width="300px" src="assets/images/feed/<?php echo $_SESSION['username']."/".$row[$i]->url; ?>" /></center>
                <div class="photo__info">
                    ...
                    <span class="photo__likes"><?php echo $row[$i]->like; ?></span>
