...
<body>
    <nav class="navigation">
        <div class="navigation__column">
            <a href="<?php echo base_url('Controller_feeds');?>">
                <img src="<?php echo base_url();?>assets/images/logo.png" />
            </a>
        </div>
        <div class="navigation__column">
            <i class="fa fa-search"></i>
            <form action="<?php echo base_url('controller_explore/search');?>" method="GET">
        ...
        <div class="navigation__column">
            <ul class="navigations__links">
                <li class="navigation__list-item">
                    <a href="<?php echo base_url('controller_explore');?>" class="navigation__link">
                ...
                <li class="navigation__list-item">
                    <a href="<?php echo base_url('controller_profile');?>" class="navigation__link">
        ...
        <header class="profile__header">
            ...
            <div class="profile__column">
                <div class="profile__title">
                    ...
                    <a href="<?php echo base_url('controller_editprofile');?>">Edit profile</a>
                    <a href="<?php echo base_url('controller_profile/logout');?>"><i class="fa fa-cog fa-lg"></i></a>
                </div>
