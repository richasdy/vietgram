    ...
    <main id="profile">
        <header class="profile__header">
            <div class="profile__column">
                <img src="assets/images/avatar.jpg" width="150px" height="150px" />
            </div>
            <div class="profile__column">
                ...
                <ul class="profile__stats">
                    <li class="profile__stat">
                        <span class="stat__number">2</span> posts
                    </li>
                    <li class="profile__stat">
                        <span class="stat__number">10000</span> followers
                    </li>
                    <li class="profile__stat">
        ...
        ?>
            <div class="profile__photo">
                <img src="assets/images/saya/<?php echo $_SESSION['username']."/".$row[$i]->url; ?>" />
